...
var solaceWrapper = {
    TopicSubscriber (topicName,hosturl,username,pass,vpn,messageCallback) {
        'use strict';
        var subscriber = {};
        ...
        subscriber.log = function (line) {
            //console.log('Subscriber log: '+line)
        };
        ...
        subscriber.connect = function () {
            ...
            subscriber.session.on(solace.SessionEventCode.MESSAGE, function (message) {
                messageCallback(message.getBinaryAttachment());
            });
